      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div id='contain-historia' className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-4">
          ...
          <div  className="cont-text md:w-1/2">
            ...
            Prompt fusiona la artesanía cervecera con la innovación tecnológica. Nuestra IA selecciona los ingredientes premium, mientras que la robótica perfecciona cada fase de la elaboración. El resultado: una cerveza excepcional que define el futuro de la tradición cervecera            </p>
          </div>
